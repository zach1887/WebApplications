...
public class InterestCalculator_v2 {
 public static void main(String[] args) {
     ...
     // I decided to provide three outcomes for the compounding period instead of asking for an integer.
        ...
        else if (inputCompounds.equals("m")) numCompounds = 12;
        else if (inputCompounds.equals("d")) numCompounds = 365;
        else numCompounds = 1;  // if this happens, something went wrong
